...
angular.module('igl').config(function ($routeProvider, RestangularProvider, $mdAriaProvider, $httpProvider, KeepaliveProvider, IdleProvider, NotificationProvider,blockUIConfig, flowFactoryProvider,$locationProvider) {
  ...
  $routeProvider
    ...
    .when('/ig', {
      templateUrl: 'app/views/ig.html'
    })
    .when('/profileComponent', {
      templateUrl: 'app/views/profileComponent.html'
    })
    .when('/compare', {
      templateUrl: 'app/views/compare.html'
    })
    .when('/datatypeLibrary', {
      templateUrl: 'app/views/datatypeLibrary.html',
    ...
    .when('/forgotten', {
      templateUrl: 'app/views/account/forgotten.html',
    ...
    .when('/registration', {
      templateUrl: 'app/views/account/registration.html',
      controller: 'RegistrationCtrl'
    }).when('/useraccount', {
    templateUrl: 'app/views/account/userAccount.html'
  }) .when('/glossary', {
  ...
  //        })
    .when('/registerResetPassword', {
      templateUrl: 'app/views/account/registerResetPassword.html',
    ...
    .when('/registrationSubmitted', {
      templateUrl: 'app/views/account/registrationSubmitted.html'
    })
    .otherwise({
      redirectTo: '/'
    });
