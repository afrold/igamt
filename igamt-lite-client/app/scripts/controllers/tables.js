...
angular.module('igl').controller('TableListCtrl',function($scope, $rootScope, Restangular, ngTreetableParams, $filter, $http, $modal) {
					...
					$scope.cloneTable = function(table) {						
						...
						$rootScope.newTable.type = 'table';
						$rootScope.newTable.mappingId = table.mappingId + '_' + $rootScope.postfixCloneTable + $rootScope.newTableFakeId;
						$rootScope.newTable.mappingAlternateId = table.mappingAlternateId + '_' + $rootScope.postfixCloneTable + $rootScope.newTableFakeId;
						$rootScope.newTable.name = table.name + '_' + $rootScope.postfixCloneTable + $rootScope.newTableFakeId;
						$rootScope.newTable.version = table.version;
						$rootScope.newTable.oid = table.oid;
						$rootScope.newTable.tableType = table.tableType;
						$rootScope.newTable.stability = table.stability;
						$rootScope.newTable.extensibility = table.extensibility;
						
						for(var i=0, len1 = table.codes.length; i < len1; i ++){
							$rootScope.newCodeFakeId = $rootScope.newCodeFakeId - 1;
							$rootScope.newTable.codes.push({
								id : $rootScope.newCodeFakeId,
								type : 'code',
