...
//					console.log("drop");
		...
		.directive(
				"branch",
				function($compile) {
					var branchNoCtxTemplate = "<li class='branch' ng-class=\" {'toc-selected' : branch.selected, 'selected': models.selected === branch} \" prevent-right-click>"
						...
						+ "</label>"
						+ "<span ng-click='tocSelection(branch)'>{{branch.label}}</span>"
					...
					var branchTemplate = "<li class='branch'"
						+ " context-menu context-menu-close='closedCtxSubMenu(branch)' ng-class=\" {'toc-selected' : branch.selected, 'selected': models.selected === branch} \" data-target='contextDiv.html'> "
					...
					var branchMessagesTemplate = "<li class='branch'"
						+ " context-menu context-menu-close='closedCtxSubMenu(branch)' ng-class=\" {'toc-selected' : branch.selected, 'selected': models.selected === branch} \" data-target='messageHeadContextDiv.html'>"
						+ "<input type='checkbox' id='{{branch.id}}' ng-model='branch.selected'></input>"
						+ "<label for='{{branch.id}}' class='fa' ng-class=\" {'fa-caret-right': branch.selected,'fa-caret-down': !branch.selected} \">"
						+ "</label>"
						+ "<span ng-click='tocSelection(branch)'>{{branch.label}}</span>"
					...
					var branchTablesTemplate = "<li class='branch'"
						+ " context-menu context-menu-close='closedCtxSubMenu(branch)' ng-class=\" {'toc-selected' : branch.selected, 'selected': models.selected === branch} \" data-target='tableHeadContextDiv.html'>"
						+ "<label for='{{branch.id}}' class='fa' ng-class=\" {'fa-caret-right': branch.selected,'fa-caret-down': !branch.selected} \" ng-click='tocSelection(branch)'>"
						+ "</label>"
						+ "<span ng-click='tocSelection(branch)'>{{branch.label}}</span>"
						+ "<input type='checkbox' id='{{branch.id}}' ng-model='branch.selected'/>"
