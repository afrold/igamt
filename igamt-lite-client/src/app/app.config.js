...
angular.module('igl').config(function ($routeProvider, RestangularProvider, $mdAriaProvider, $httpProvider, KeepaliveProvider, IdleProvider, NotificationProvider,blockUIConfig, flowFactoryProvider,$locationProvider) {
  ...
  $routeProvider
    ...
    .when('/ig', {
      templateUrl: 'src/app/views/ig.html'
    })
    .when('/profileComponent', {
      templateUrl: 'src/app/views/profileComponent.html'
    })
    .when('/compare', {
      templateUrl: 'src/app/views/compare.html'
    })
    .when('/datatypeLibrary', {
      templateUrl: 'src/app/views/datatypeLibrary.html',
      controller: 'DatatypeLibraryCtl'
    })
    .when('/shared', {
      templateUrl: 'src/app/views/shared.html',
      controller: 'shared'
    })
    .when('/doc', {
      templateUrl: 'src/app/views/doc.html',
      controller: 'DocumentationController'
    })
    .when('/configuration', {
      templateUrl: 'src/app/views/configuration.html',
    ...
    .when('/setting', {
      templateUrl: 'src/app/views/setting.html'
    })
    .when('/about', {
    ...
    .when('/forgotten', {
      templateUrl: 'src/app/views/account/forgotten.html',
      controller: 'ForgottenCtrl'
    })
    .when('/issue', {
      templateUrl: 'src/app/views/issue.html',
      controller: 'IssueCtrl'
    })
    .when('/registration', {
      templateUrl: 'src/app/views/account/registration.html',
      controller: 'RegistrationCtrl'
    }).when('/useraccount', {
    templateUrl: 'src/app/views/account/userAccount.html'
  }) .when('/glossary', {
    templateUrl: 'src/app/views/glossary.html'
  })
  //        .when('/account', {
  //            templateUrl: 'src/app/views/account/account.html',
  ...
  //        })
    .when('/registerResetPassword', {
      templateUrl: 'src/app/views/account/registerResetPassword.html',
    ...
    .when('/registrationSubmitted', {
      templateUrl: 'src/app/views/account/registrationSubmitted.html'
    })
    .otherwise({
      redirectTo: '/'
    });
...
angular.module('igl').run(function ($rootScope, $location, Restangular, $modal, $filter, base64, userInfoService, $http, AppInfo, StorageService, $templateCache, $window, Notification) {
  ...
  AppInfo.get().then(function (appInfo) {
    ...
    $rootScope.appInfo = {};
    $rootScope.openErrorDlg("Sorry. Failed to initialize the application");
  });
