...
public class Profile2 extends TextbasedSectionModel implements java.io.Serializable, Cloneable {
	...
	@Override
	public Profile2 clone() throws CloneNotSupportedException {
		Profile2 clonedProfile = new Profile2();
