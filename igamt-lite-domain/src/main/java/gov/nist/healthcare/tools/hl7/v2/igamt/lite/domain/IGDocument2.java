...
public class IGDocument2 extends DataModel implements java.io.Serializable,
		Cloneable {
	...
	@Override
	public IGDocument2 clone() throws CloneNotSupportedException {
		IGDocument2 clonedDocument = new IGDocument2();
	...
	public void addProfile(Profile2 p) {
