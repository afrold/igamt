...
@PropertySource(value = { "classpath:testAuthWeb.properties",
		"classpath:testConfigurationWeb.properties" })
...
public class TestAccountConfig {
	...
	public DataSource dataSource() {
		...
		dataSource.setUrl("jdbc:mysql://localhost:3306/igl");
		dataSource.setUsername("igluser");
