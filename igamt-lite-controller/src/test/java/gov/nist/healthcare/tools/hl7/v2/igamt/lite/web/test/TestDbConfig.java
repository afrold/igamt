...
public class TestDbConfig extends AbstractMongoConfiguration {
  ...
  public Mongo mongo() throws Exception {
    MongoCredential credential =
        MongoCredential.createMongoCRCredential(env.getProperty("mongo.username"),
            env.getProperty("mongo.dbname"), env.getProperty("mongo.password").toCharArray());
    return new MongoClient(new ServerAddress("localhost", Integer.valueOf(env
        .getProperty("mongo.port"))), Arrays.asList(credential));
  }
