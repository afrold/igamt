...
public class SegmentLibraryController extends CommonController {
  ...
  public List<Segment> findByScopesAndVersion(@RequestBody ScopesAndVersionWrapper scopesAndVersion) {
    ...
    try {
      segments =
          segmentService.findByScopesAndVersion(scopesAndVersion.getScopes(),
              scopesAndVersion.getHl7Version());
      if (segments == null) {
  ...
  public ResponseMessage addSegment(@PathVariable("segLibId") String segLibId,
      @RequestParam("segId") String segId) throws SegmentSaveException, ForbiddenOperationException {
