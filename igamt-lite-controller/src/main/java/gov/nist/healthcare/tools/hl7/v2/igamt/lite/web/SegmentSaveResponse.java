...
public class SegmentSaveResponse extends ResponseMessage {
  ...
  public SegmentSaveResponse(Type type, String text, String resourceId, String manualHandle,
  ...
  public SegmentSaveResponse(Type type, String text, List<DatatypeSaveError> errors) {
    super(type, text);
    this.errors = errors;
  }
