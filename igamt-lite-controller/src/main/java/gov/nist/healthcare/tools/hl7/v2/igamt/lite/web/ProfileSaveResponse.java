...
public class ProfileSaveResponse extends ResponseMessage {
  ...
  public ProfileSaveResponse(Type type, String text, String resourceId, String manualHandle,
  ...
  public ProfileSaveResponse(Type type, String text, List<ProfilePropertySaveError> errors) {
    super(type, text);
    this.errors = errors;
  }
