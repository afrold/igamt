...
public class VerificationController extends CommonController {
  ...
  private Profile findProfile(String profileId) throws ProfileNotFoundException {
  ...
  public ElementVerification verifyMessage(@PathVariable("id") String id,
      @PathVariable("mId") String mId, HttpServletRequest request, HttpServletResponse response)
  ...
  public ElementVerification verifySegmentRefOrGroup(@PathVariable("id") String id,
  ...
  public ElementVerification verifyField(@PathVariable("id") String id,
      @PathVariable("fId") String fId, HttpServletRequest request, HttpServletResponse response)
      throws IOException, ProfileNotFoundException {
  ...
  public ElementVerification verifyComponent(@PathVariable("id") String id,
      @PathVariable("cId") String cId, HttpServletRequest request, HttpServletResponse response)
      throws IOException, ProfileNotFoundException {
  ...
  public ElementVerification verifyLength(@PathVariable("id") String id,
      @PathVariable("eltId") String eltId, @RequestParam String type, @RequestParam String attName,
      @RequestParam String attValue, HttpServletRequest request, HttpServletResponse response)
      throws IOException, ProfileNotFoundException {
  ...
  public ElementVerification verifyCardinality(@PathVariable("id") String id,
      @PathVariable("eltId") String eltId, @RequestParam String type, @RequestParam String attName,
      @RequestParam String attValue, HttpServletRequest request, HttpServletResponse response)
      throws IOException, ProfileNotFoundException {
    logger.info("Verifying length of element " + eltId + " from profile " + id);
  ...
  public ElementVerification verifyUsage(@PathVariable("id") String id,
      @PathVariable("eltId") String eltId, @RequestParam String type, @RequestParam String attName,
      @RequestParam String attValue, HttpServletRequest request, HttpServletResponse response)
      throws IOException, ProfileNotFoundException {
    logger.info("Verifying length of element " + eltId + " from profile " + id);
