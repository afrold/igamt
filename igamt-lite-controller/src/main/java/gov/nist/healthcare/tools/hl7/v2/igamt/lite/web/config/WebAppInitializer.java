...

{
  ...
  public void onStartup(final ServletContext servletContext) throws ServletException {
    ...
    root.scan("gov.nist.healthcare.tools.hl7.v2.igamt.lite", "gov.nist.healthcare.nht.acmgt");
    // web app servlet
    servletContext.addListener(new ContextLoaderListener(root));
    Dynamic servlet = servletContext.addServlet("igamt", new DispatcherServlet(root));
    ...
    try {
      ...
      environment.getPropertySources().addFirst(
          new ResourcePropertySource("classpath:app-web-config.properties"));
