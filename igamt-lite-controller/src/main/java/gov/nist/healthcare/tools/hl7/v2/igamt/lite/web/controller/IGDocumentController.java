...
import gov.nist.healthcare.tools.hl7.v2.igamt.lite.domain.IGDocumentExportConfig;
...
public class IGDocumentController extends CommonController {
  ...
  public void exportValidationXMLByCompositeProfile(@PathVariable("id") String id,
    ...
    response.setHeader("Content-disposition",
        "attachment;filename=" + updateFileName(d.getMetaData().getTitle()) + "-CompositeProfile_"
  ...
  @RequestMapping(value = "/{id}/export/Display/Composite/{cIds}", method = RequestMethod.POST,
      produces = "application/zip", consumes = "application/x-www-form-urlencoded; charset=UTF-8")
  ...
  @RequestMapping(value = "/{id}/export/Gazelle/Composite/{cIds}", method = RequestMethod.POST,
      produces = "application/zip", consumes = "application/x-www-form-urlencoded; charset=UTF-8")
  ...
  public boolean saveExportConfig(@PathVariable("id") String id,
      @RequestBody IGDocumentExportConfig exportConfig, HttpServletRequest request,
