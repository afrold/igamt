...
public class IGDocumentSaveResponse extends ResponseMessage {
  ...
  public IGDocumentSaveResponse(Type type, String text, String resourceId, String manualHandle,
  ...
  public IGDocumentSaveResponse(Type type, String text, List<IGDocumentPropertySaveError> errors) {
    super(type, text);
    this.errors = errors;
  }
