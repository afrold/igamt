...
import gov.nist.healthcare.tools.hl7.v2.igamt.lite.repo.DatatypeLibraryDocumentRepositoryImpl;
...
public class DataTypeLibraryDocumentServiceImpl implements DatatypeLibraryDocumentService {
  ...
  public List<DatatypeLibraryDocument> findByScopesAndVersion(List<SCOPE> scopes, String hl7Version) {
    ...
    List<DatatypeLibraryDocument> datatypeLibraries =
    		datatypeLibraryDocumentRepository.findScopesNVersion(scopes, hl7Version);
  ...
  public List<DatatypeLibraryDocument> findByAccountId(Long accountId, String hl7Version) {
    List<DatatypeLibraryDocument> datatypeLibrary =
    		datatypeLibraryDocumentRepository.findByAccountId(accountId, hl7Version);
  ...
  public DatatypeLibraryDocument create(String name, String ext, SCOPE scope, String hl7Version,
    ...
    datatypeLibraryDocument.setDatatypeLibrary(datatypeLibraryService.create(name, ext, scope, hl7Version, accountId));
