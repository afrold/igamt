...
import gov.nist.healthcare.tools.hl7.v2.igamt.lite.repo.StandardRepository;
...
public class StandardService {
	...
	public Standard save(Standard c) {
		return standardRepository.save(c);
	}
	...
	public Standard findOne(String id) {
