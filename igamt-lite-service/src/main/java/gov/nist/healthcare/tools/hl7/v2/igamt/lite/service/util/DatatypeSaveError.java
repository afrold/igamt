 ...
 *
 */
public class DatatypeSaveError extends AbscractPropertySaveError {
   ...
   * @param command
   */
  public DatatypeSaveError(String targetId, String targetType, String propertyName,
   ...
   * @param errorMsg
   */
  public DatatypeSaveError(String targetId, String targetType, String errorMsg) {
    super(targetId, targetType, errorMsg);
  }

  @Override
  public String toString() {
    return "DatatypeLibrarySaveError [targetId=" + this.getTargetId() + ", propertyName="
