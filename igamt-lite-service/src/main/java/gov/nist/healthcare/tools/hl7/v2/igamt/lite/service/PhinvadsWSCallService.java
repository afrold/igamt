	...
	public Set<Table> generateTableList(String searchText) throws MalformedURLException {
		...
		if (valueSets != null) {
			for (ValueSet vs : valueSets) {
				 ...
				 * System.out.println(vs.getAssigningAuthorityId());
				 * System.out.println(vs.getCode());
				 * System.out.println(vs.getDefinitionText());
				 * System.out.println(vs.getId());
				 * System.out.println(vs.getName());
				 * System.out.println(vs.getOid());
				 * System.out.println(vs.getScopeNoteText());
				 * System.out.println(vs.getStatus());
				 * System.out.println(vs.getStatusDate());
				 * System.out.println(vs.getValueSetCreatedDate());
				 * System.out.println(vs.getValueSetLastRevisionDate());
				 * System.out.println("---vsvByVSOids---"); for(ValueSetVersion
				 * vsv : vsvByVSOid){
				 * System.out.println(vsv.getAssigningAuthorityText());
				 * System.out.println(vsv.getAssigningauthoritytext());
				 * System.out.println(vsv.getDescription());
				 * System.out.println(vsv.getId());
				 * System.out.println(vsv.getNoteText());
				 * System.out.println(vsv.getStatus());
				 * System.out.println(vsv.getValueSetOid());
				 * System.out.println(vsv.getVersionNumber());
				 * System.out.println(vsv.getAssigningAuthorityReleaseDate());
				 * System.out.println(vsv.getEffectiveDate());
				 * System.out.println(vsv.getExpiryDate());
				 * System.out.println(vsv.getStatusDate());
				 * System.out.println("------------"); }
				 * 
				 ...
				 * 
				 * System.out.println("---ValueSetConcepts---"); int index = 0;
				 * for(ValueSetConcept vsc : valueSetConcepts){ index = index +
				 ...
				 * System.out.println(vsc.getCodeSystemOid());
				 * System.out.println(vsc.getConceptCode());
				 * System.out.println(vsc.getDefinitionText());
				 * System.out.println(vsc.getId());
				 * System.out.println(vsc.getPreferredAlternateCode());
				 * System.out.println(vsc.getScopeNoteText());
				 * System.out.println(vsc.getStatus());
				 * System.out.println(vsc.getValueSetVersionId());
				 * System.out.println(vsc.getSequence());
				 * System.out.println(vsc.getStatusDate());
				 * 
				 * CodeSystemSearchCriteriaDto csSearchCritDto = new
				 ...
				 * 
				 * System.out.println(this.getService().findCodeSystems(
				 * csSearchCritDto, 1, 5)
