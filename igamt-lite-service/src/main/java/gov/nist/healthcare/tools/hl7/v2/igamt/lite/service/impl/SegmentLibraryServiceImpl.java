...
public class SegmentLibraryServiceImpl implements SegmentLibraryService {
  ...
  public List<SegmentLibrary> findByScopesAndVersion(List<SCOPE> scopes, String hl7Version) {
    ...
    List<SegmentLibrary> segmentLibraries =
        segmentLibraryRepository.findScopesNVersion(scopes, hl7Version);
    log.info("SegmentLibraryServiceImpl.findByScopesAndVersion segmentLibraries="
        + segmentLibraries.size());
    return segmentLibraries;
  }

  @Override
  public List<SegmentLibrary> findByAccountId(Long accountId, String hl7Version) {
    List<SegmentLibrary> segmentLibrary =
        segmentLibraryRepository.findByAccountId(accountId, hl7Version);
  ...
  @Override
  public SegmentLibrary create(String name, String ext, SCOPE scope, String hl7Version,
      Long accountId) {
