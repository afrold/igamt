 ...
 */
public class IGDocumentPropertySaveError extends AbscractPropertySaveError {
  /**
   * @param targetId
   * @param fieldName
   * @param targetType
   ...
   * @param command
   */
  public IGDocumentPropertySaveError(String targetId, String targetType, String propertyName,
   ...
   * @param errorMsg
   */
  public IGDocumentPropertySaveError(String targetId, String targetType, String errorMsg) {
    super(targetId, targetType, errorMsg);
  }

  @Override
  public String toString() {
    return "IGDocumentPropertySaveError [targetId=" + this.getTargetId() + ", propertyName="
