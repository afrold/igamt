...
public class ProfileServiceDeltaTest {
  ...
  public static void setup() {
    try {
      ...
      InputStream log4jFile =
          ProfileServiceDeltaTest.class.getResourceAsStream("/igl-test-log4j.properties");
      p.load(log4jFile);
  ...
  public void testDelta() throws Exception {
    ...
    Profile p1 =
        test1
            .deserializeXMLToProfile(
                new String(Files.readAllBytes(Paths.get("src//main//resources//vxu//Profile.xml"))),
    ...
    Message message = p2.getMessages().getChildren().toArray(new Message[] {})[0];
    ...
    Datatype datatype = p2.getDatatypeLibrary().getChildren().toArray(new Datatype[] {})[0];
    ...
    segment
        .setText1("<h2>Test format!</h2><p>textAngular WYSIWYG Text Editor</p><p><b>Features:</b></p><ol><li>Two-Way-Binding</li><li style=\"color: ;\"><b>Theming</b> Options</li><li>Simple Editor Instance Creation</li></ol><p><b>Link test:</b> <a href=\"https://github.com/fraywing/textAngular\">Here</a> </p>");
