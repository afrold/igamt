 ...
 *
 */
public class SegmentLibraryReadConverterTest {

	private static final Logger log = LoggerFactory.getLogger(SegmentLibraryReadConverterTest.class);
	...
	public static void setUpBeforeClass() throws Exception {
		...
		coll = mongoOps.getCollection("segment-library");
	}

	@Test
	public void testConvert() {
		SegmentLibraryReadConverter cnv = new SegmentLibraryReadConverter();
		DBCursor cur = coll.find();
		while (cur.hasNext()) {
			DBObject source = cur.next();
			SegmentLibrary sut = cnv.convert(source);
			assertNotNull(sut);
		}
	}
