...
public class ProfileChangeServiceTest {
  ...
  public static void setup() {
    try {
      ...
      InputStream log4jFile =
          ProfileChangeServiceTest.class.getResourceAsStream("/igl-test-log4j.properties");
      p.load(log4jFile);
  ...
  public void testApplyProfileMetaDataChanges() throws IOException {
    ...
    try {
      List<ProfilePropertySaveError> errors = new ProfileChangeService().apply(jsonChanges, p1);
  ...
  public void testApplyMessageChanges() throws IOException {
    ...
    Message message = p1.getMessages().getChildren().toArray(new Message[] {})[0];
    ...
    Datatype datatype = p1.getDatatypeLibrary().getChildren().toArray(new Datatype[] {})[0];
    String jsonChanges =
        "{\r\n  \"segmentRef\": {\r\n    \"edit\": [\r\n      {\r\n        \"id\": \""
            + segmentRef.getId()
            + "\",\r\n        \"usage\": \"X\",\r\n        \"min\": \"100\",\r\n        \"max\": \"100\"\r\n      }\r\n    ]\r\n  },\r\n  \"message\": {\r\n    \"edit\": [\r\n      {\r\n        \"id\": \""
