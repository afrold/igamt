...
public class SerializationServiceTest {
    ...
    public void testSerializeCompactIGDocument(){
        ...
        Document document = serializationService.serializeIGDocument(igDocument, SerializationLayout.COMPACT, ExportConfig.getBasicExportConfig());
    ...
    public void testSerializeVerboseIGDocument(){
        IGDocument igDocument = igDocumentService.findById(IG_DOCUMENT_TEST_ID);
        assertTrue(igDocument!=null);
        Document document = serializationService.serializeIGDocument(igDocument, SerializationLayout.VERBOSE, ExportConfig.getBasicExportConfig());
        String xmlDocument = document.toXML();
        System.out.println(xmlDocument);
    }
    @Test
