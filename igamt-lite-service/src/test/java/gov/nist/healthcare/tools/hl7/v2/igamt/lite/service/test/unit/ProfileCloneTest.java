...
public class ProfileCloneTest {
	...
	private Profile profile() {
		...
		try {
			xmlContentsProfile = IOUtils.toString(ProfileCloneTest.class
					.getResourceAsStream("/vxu/Profile.xml"));
			String xmlValueSet = IOUtils.toString(ProfileCloneTest.class
					.getResourceAsStream("/vxu/ValueSets_all.xml"));
			String xmlConstraints = IOUtils.toString(ProfileCloneTest.class
